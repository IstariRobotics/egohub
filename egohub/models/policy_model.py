...
class LatentPolicyModel(nn.Module):
    ...
    def __init__(
        ...
        encoder_layers = nn.TransformerEncoderLayer(latent_dim, nhead, d_hid, dropout, batch_first=True)
    ...
    def forward(self, src: torch.Tensor, src_mask: torch.Tensor = None) -> torch.Tensor:
        ...
        Returns:
            output: The predicted next latent vector. Shape: [batch_size, seq_len, latent_dim].
        """
