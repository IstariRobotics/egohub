...
class MultimodalVAE(nn.Module):
    ...
    def __init__(
        ...
        self.image_encoder = ImageEncoder(
            in_channels=image_channels, out_features=image_feature_dim
        )
        self.pose_encoder = PoseEncoder(
            in_features=pose_input_dim, out_features=pose_feature_dim
        )
        ...
        self.pose_decoder = nn.Sequential(
            nn.Linear(pose_feature_dim, 256), nn.ReLU(), nn.Linear(256, pose_input_dim)
        )
    ...
    def decode(self, z):
        ...
        # Assuming the first part of h_decoded is for the image and the second
        # for the pose
