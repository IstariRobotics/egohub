...
CANONICAL_SKELETON_JOINTS: list[str] = [
    ...
    # Left Hand Fingers
    'left_hand_index_metacarpal', 'left_hand_index_knuckle', 'left_hand_index_intermediate_base',
    'left_hand_index_intermediate_tip', 'left_hand_index_tip',
    'left_hand_little_finger_metacarpal', 'left_hand_little_finger_knuckle', 'left_hand_little_finger_intermediate_base',
    'left_hand_little_finger_intermediate_tip', 'left_hand_little_finger_tip',
    'left_hand_middle_finger_metacarpal', 'left_hand_middle_finger_knuckle', 'left_hand_middle_finger_intermediate_base',
    'left_hand_middle_finger_intermediate_tip', 'left_hand_middle_finger_tip',
    'left_hand_ring_finger_metacarpal', 'left_hand_ring_finger_knuckle', 'left_hand_ring_finger_intermediate_base',
    'left_hand_ring_finger_intermediate_tip', 'left_hand_ring_finger_tip',
    'left_hand_thumb_knuckle', 'left_hand_thumb_intermediate_base', 'left_hand_thumb_intermediate_tip', 'left_hand_thumb_tip',

    # Right Hand Fingers
    'right_hand_index_metacarpal', 'right_hand_index_knuckle', 'right_hand_index_intermediate_base',
    'right_hand_index_intermediate_tip', 'right_hand_index_tip',
    'right_hand_little_finger_metacarpal', 'right_hand_little_finger_knuckle', 'right_hand_little_finger_intermediate_base',
    'right_hand_little_finger_intermediate_tip', 'right_hand_little_finger_tip',
    'right_hand_middle_finger_metacarpal', 'right_hand_middle_finger_knuckle', 'right_hand_middle_finger_intermediate_base',
    'right_hand_middle_finger_intermediate_tip', 'right_hand_middle_finger_tip',
    'right_hand_ring_finger_metacarpal', 'right_hand_ring_finger_knuckle', 'right_hand_ring_finger_intermediate_base',
    'right_hand_ring_finger_intermediate_tip', 'right_hand_ring_finger_tip',
    'right_hand_thumb_knuckle', 'right_hand_thumb_intermediate_base', 'right_hand_thumb_intermediate_tip', 'right_hand_thumb_tip',
]
...
AVP_LINKS = (
    ...
    (39, 38),  # rightIndexFingerMetacapackageal -> rightIndexFingerKnuckle
